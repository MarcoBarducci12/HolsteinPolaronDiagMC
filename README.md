...
At each step we collect the order and evaluate the energy of the current diagram via the use of an estimator which, in the end, when averaged over the MonteCarlo samples retrieves $E_{GS}$
